...
class FitatuBarcodeScannerHostApi {
  ...
  Future<void> init(ScannerOptions options) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.fitatu_barcode_scanner.FitatuBarcodeScannerHostApi.init$pigeonVar_messageChannelSuffix';
  ...
  Future<void> release() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.fitatu_barcode_scanner.FitatuBarcodeScannerHostApi.release$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> setTorchEnabled(bool isEnabled) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.fitatu_barcode_scanner.FitatuBarcodeScannerHostApi.setTorchEnabled$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
